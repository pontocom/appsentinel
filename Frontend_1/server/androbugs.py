...
TYPE_REPORT_OUTPUT_RETURNS = "returns"
...
REPORT_OUTPUT = TYPE_REPORT_OUTPUT_RETURNS
...
def main(argType=None,apkName=None) :
	...
	if writer.get_analyze_status() == "success" :
		...
		elif REPORT_OUTPUT == TYPE_REPORT_OUTPUT_RETURNS :
			return json.dumps(writer.get_packed_analyzed_results_for_mongodb(), indent=4, sort_keys=True, default=str)
